// The browser unit-test runner does not run the app's plugin registrant.
// These are the exact transitive web implementations pinned by pubspec.lock.
